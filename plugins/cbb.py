...
@Bot.on_message(filters.command("bought") & filters.private)
async def bought(client: Bot, message: Message):
    msg = await message.reply('Wait, I am checking...')
    ...
    if not replied:
        ...
        await msg.edit("<b>Please reply with the screenshot of your payment for the premium purchase to proceed.</b>")
